...
const UsersManagementCard = () => {
    return (
        <div className="bg-black p-6 rounded-lg w-full max-w-sm border border-stone-600 shadow-lg flex flex-col items-center">
            ...
            >
                <button
                    className="bg-purple-600 hover:bg-purple-700 h-12 text-white font-bold py-2 px-4 rounded-md transition-colors duration-300 flex items-center justify-center"
                >
                    Go to Users
                    <svg
